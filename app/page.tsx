...
export const metadata = {
  ...
  description: 'A simple starter template for building modular Next.js apps with App Router and FSD.',
};
      ...
      <main className={styles.home}>
        <div className={styles.container}>
          ...
          <p>
            ...
            <strong>ESLint</strong>, <strong>Prettier</strong>, <strong>Stylelint</strong>, and follows
            the <strong>Feature-Sliced Design</strong> methodology.
          </p>
